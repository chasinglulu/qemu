...
static RISCVException read_mtvt(CPURISCVState *env, int csrno, target_ulong *val)
{
    *val = env->mtvt;
    return RISCV_EXCP_NONE;
}

static RISCVException write_mtvt(CPURISCVState *env, int csrno, target_ulong val)
{
...
static RISCVException rmw_mnxti(CPURISCVState *env, int csrno, target_ulong *ret_value,
...
static RISCVException read_mintstatus(CPURISCVState *env, int csrno, target_ulong *val)
{
    *val = env->mintstatus;
    return RISCV_EXCP_NONE;
}

static RISCVException read_mintthresh(CPURISCVState *env, int csrno, target_ulong *val)
{
    *val = env->mintthresh;
    return RISCV_EXCP_NONE;
}

static RISCVException write_mintthresh(CPURISCVState *env, int csrno, target_ulong val)
{
    env->mintthresh = val;
    return RISCV_EXCP_NONE;
}
...
static RISCVException read_stvt(CPURISCVState *env, int csrno, target_ulong *val)
{
    *val = env->stvt;
    return RISCV_EXCP_NONE;
}

static RISCVException write_stvt(CPURISCVState *env, int csrno, target_ulong val)
{
...
static RISCVException rmw_snxti(CPURISCVState *env, int csrno, target_ulong *ret_value,
                     target_ulong new_value, target_ulong write_mask)
{
    int clic_priv, clic_il, clic_irq;
    bool ready;
...
static RISCVException read_sintstatus(CPURISCVState *env, int csrno, target_ulong *val)
{
...
static RISCVException read_sintthresh(CPURISCVState *env, int csrno, target_ulong *val)
{
    *val = env->sintthresh;
    return RISCV_EXCP_NONE;
}

static RISCVException write_sintthresh(CPURISCVState *env, int csrno, target_ulong val)
{
    env->sintthresh = val;
    return RISCV_EXCP_NONE;
}
