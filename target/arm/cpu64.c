...
static const ARMCPRegInfo a55_cp_reginfo[] = {
    ...
    { .name = "CPUECTLR_EL1", .state = ARM_CP_STATE_AA64,
      ...
      .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0x2800BC00 },
...
static void define_cortex_a55_cp_reginfo(ARMCPU *cpu)
{
    define_arm_cp_regs(cpu, dsu_cp_reginfo);
    define_arm_cp_regs(cpu, a55_cp_reginfo);
}
...
static void aarch64_a55_initfn(Object *obj)
{
    ...
    define_cortex_a55_cp_reginfo(cpu);
}
...
static void define_cortex_a76_cp_reginfo(ARMCPU *cpu)
{
    define_arm_cp_regs(cpu, dsu_cp_reginfo);
}
...
static const ARMCPRegInfo cortex_a78ae_cp_reginfo[] = {
    { .name = "ATCR_EL1", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 0, .crn = 15, .crm = 7, .opc2 = 0,
      .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
    { .name = "ATCR_EL2", .state = ARM_CP_STATE_AA64,
...
static void define_cortex_a78ae_cp_reginfo(ARMCPU *cpu)
{
    define_arm_cp_regs(cpu, cortex_a78ae_cp_reginfo);
}
...
static void aarch64_a78ae_initfn(Object *obj)
{
    ...
    define_cortex_a78ae_cp_reginfo(cpu);
}
